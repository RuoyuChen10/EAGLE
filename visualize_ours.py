...
from utils import *
from visualization.visualization import visualization_mllm

def parse_args():
    parser = argparse.ArgumentParser(description='Faithfulness Metric')
    parser.add_argument('--explanation-dir', 
                        type=str, 
                        default='interpretation_results/Qwen2.5-VL-3B-RePOPE-TN/slico-1.0-1.0-division-number-64',
...
def main(args):
    ...
    for json_file_name in tqdm(json_file_names):
        ...
        visualization_mllm(image_path, S_set, saved_json_file, save_path=save_full_visualization_map_path)
