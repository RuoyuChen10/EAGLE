...
def parse_args():
    ...
    parser.add_argument('--save-dir', 
                        type=str, default='./interpretation_results/InternVL3_5-4B-coco-caption/',
