...
def tam_demo_for_llava(model, processor, image_path, prompt_text, token_id, save_path):
...
def main(args):
    ...
    for content in tqdm(select_contents):
        ...
        # try:
        heatmap = tam_demo_for_llava(model, processor, image_path, text_prompt, token_id=selected_interpretation_token_id, save_path=os.path.join(visualization_root_path, content["image_path"]))
